...
extern EIF_TYPED_VALUE F14_441(EIF_REFERENCE);
extern EIF_TYPED_VALUE F14_442(EIF_REFERENCE);
extern EIF_TYPED_VALUE F14_443(EIF_REFERENCE);
extern EIF_TYPED_VALUE F14_444(EIF_REFERENCE);
extern EIF_TYPED_VALUE F14_445(EIF_REFERENCE);
extern EIF_TYPED_VALUE F14_446(EIF_REFERENCE);
extern EIF_TYPED_VALUE F14_447(EIF_REFERENCE);
extern EIF_TYPED_VALUE F14_448(EIF_REFERENCE);
...
EIF_TYPED_VALUE F14_441 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F14_441,611,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F14_442)
EIF_TYPED_VALUE F14_442 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 13, Current, 0, 0, 611);
	RTSA(Dtype(Current));
	RTSC;
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {265,194,0xFFFF};
		EIF_TYPE typres0;
	...
	*((EIF_REFERENCE *)tr2+6) = (EIF_REFERENCE) tr3;
	RTAR(tr2,tr3);
	tr1 = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE))  RTWF(2423, Dtype(tr2)))(tr2).it_r;
...
RTOID (F14_443)
EIF_TYPED_VALUE F14_443 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 13, Current, 0, 0, 612);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
RTOID (F14_444)
EIF_TYPED_VALUE F14_444 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 13, Current, 0, 0, 613);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
RTOID (F14_445)
EIF_TYPED_VALUE F14_445 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 13, Current, 0, 0, 614);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
EIF_TYPED_VALUE F14_446 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F14_446,616,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F14_447 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F14_447,617,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F14_448 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F14_448,618,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
