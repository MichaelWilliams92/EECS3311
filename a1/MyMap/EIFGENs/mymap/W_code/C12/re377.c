...
extern EIF_TYPED_VALUE F377_2532(EIF_REFERENCE);
...
EIF_TYPED_VALUE F377_2532 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 376, Current, 0, 0, 3518);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(376, Current, 3518);
	RTIV(Current, RTAL);
	RTHOOK(1);
