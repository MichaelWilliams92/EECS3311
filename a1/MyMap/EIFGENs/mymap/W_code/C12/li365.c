...
extern EIF_TYPED_VALUE F365_2681(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F365_2682(EIF_REFERENCE);
extern EIF_TYPED_VALUE F365_2683(EIF_REFERENCE);
extern void F365_5335(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F365_2681 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 364, Current, 2, 1, 4655);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(364, Current, 4655);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tu1_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1282, "item", arg1))(arg1)).it_n1);
...
/* {LIST}.after */
EIF_TYPED_VALUE F365_2682 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 364, Current, 0, 0, 4656);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(364, Current, 4656);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F365_2683 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 364, Current, 0, 0, 4657);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(364, Current, 4657);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F365_5335 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 364, Current, 0, 5334);
	RTSA(dtype);
	RTME(dtype, 0);
