...
extern EIF_TYPED_VALUE F393_1400(EIF_REFERENCE);
extern void F393_5311(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F393_1400 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 392, Current, 0, 0, 1855);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(392, Current, 1855);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F393_5311 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 392, Current, 0, 5310);
	RTSA(dtype);
	RTME(dtype, 0);
