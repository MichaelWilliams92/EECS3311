/*
 * Code for class SUBSET_STRATEGY_HASHABLE [CHARACTER_8]
 */
...
extern EIF_TYPED_VALUE F606_790(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F606_791(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F606_790 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 605, Current, 4, 2, 959);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(605, Current, 959);
	{
...
body:;
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,606,0,0,181,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
			l_type = RTWCT(765, dtype, Dftype(Current));
			...
			*(EIF_CHARACTER_8 *)tr1 = tc1;
			...
			if (Result) {
				...
				if (tb2) {
					...
					RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
					tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1313, "item", arg1))(arg1)).it_c1);
					tc2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2275, "found_item", loc1))(loc1)).it_c1);
...
void F606_791 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 605, Current, 6, 2, 960);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(605, Current, 960);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,602,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
...
body:;
		...
		if ((EIF_TRUE)) {
			...
			if (tb3) {
				...
				if (tb3) {
					...
					tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1313, "item", arg2))(arg2)).it_c1);
					tc2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2275, "found_item", loc1))(loc1)).it_c1);
					loc3 = (EIF_BOOLEAN) (tc1 == tc2);
				} else {
					RTHOOK(20);
					RTDBGAL(Current, 3, 0x04000000, 1, 0); /* loc3 */
					tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1313, "item", arg2))(arg2)).it_c1);
					tc2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2275, "found_item", loc1))(loc1)).it_c1);
					loc3 = (EIF_BOOLEAN) (EIF_BOOLEAN)(tc1 == tc2);
				}
				RTHOOK(21);
				if (loc3) {
					RTHOOK(22);
	...
	for (;;) {
		...
		if (tb3) break;
		RTHOOK(29);
		RTDBGAL(Current, 4, 0x08000000, 0, 0); /* loc4 */
		tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2279, "item_for_iteration", loc1))(loc1)).it_c1);
