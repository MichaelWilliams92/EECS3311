...
extern void F538_1512(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F538_1513(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F538_5316(EIF_REFERENCE, int);
...
void F538_1512 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 537, Current, 2, 1, 2172);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(537, Current, 2172);
	RTCC(arg1, 537, l_feature_name, 1, RTWCT(1235, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(14);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1326, dtype))(Current, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(15);
	RTDBGLE;
...
EIF_TYPED_VALUE F538_1513 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define arg2 arg2x.it_r
	...
	RTEAA(l_feature_name, 537, Current, 1, 2, 2173);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(537, Current, 2173);
	RTCC(arg1, 537, l_feature_name, 1, RTWCT(1235, dtype, dftype), 0x00);
	{
		...
		RTCC(arg2, 537, l_feature_name, 2, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(3);
	loc1 = RTCCL(arg1);
	loc1 = RTRV(eif_new_type(141, 0x01),loc1);
	if (EIF_TEST(loc1)) {
		RTHOOK(4);
		RTDBGAL(Current, 0, 0xF800021C, 0,0); /* Result */
		{
			static EIF_TYPE_INDEX typarr0[] = {0xFF01,541,0,0,0xFFFF};
			EIF_TYPE typres0;
			{
				EIF_TYPE l_type;
				l_type = RTWCT(1235, dtype, dftype);
...
void F538_5316 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 537, Current, 0, 5315);
	RTSA(dtype);
	RTME(dtype, 0);
