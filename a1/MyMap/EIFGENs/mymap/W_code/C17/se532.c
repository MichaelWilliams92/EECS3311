...
extern EIF_TYPED_VALUE F532_1481(EIF_REFERENCE);
...
EIF_TYPED_VALUE F532_1481 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 531, Current, 0, 0, 2135);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(531, Current, 2135);
	RTIV(Current, RTAL);
	RTHOOK(1);
