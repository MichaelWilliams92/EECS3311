...
extern void F549_1512(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F549_1513(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F549_5316(EIF_REFERENCE, int);
...
void F549_1512 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 548, Current, 2, 1, 2175);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(548, Current, 2175);
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(14);
	ui4_1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1326, dtype))(Current, ui4_1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(15);
	RTDBGLE;
...
EIF_TYPED_VALUE F549_1513 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define arg2 arg2x.it_r
	...
	RTEAA(l_feature_name, 548, Current, 1, 2, 2176);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(548, Current, 2176);
	{
		...
		RTCC(arg2, 548, l_feature_name, 2, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	*(EIF_INTEGER_32 *)tr1 = arg1;
	...
	if ((EIF_TRUE)) {
		...
		RTDBGAL(Current, 0, 0xF8000228, 0,0); /* Result */
		{
			static EIF_TYPE_INDEX typarr0[] = {0xFF01,554,0,0,0xFFFF};
			EIF_TYPE typres0;
			{
				EIF_TYPE l_type;
				l_type = RTWCT(1235, dtype, dftype);
...
void F549_5316 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 548, Current, 0, 5315);
	RTSA(dtype);
	RTME(dtype, 0);
