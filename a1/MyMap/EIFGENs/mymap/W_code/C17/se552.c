...
extern EIF_TYPED_VALUE F552_1481(EIF_REFERENCE);
...
EIF_TYPED_VALUE F552_1481 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 551, Current, 0, 0, 2136);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(551, Current, 2136);
	RTIV(Current, RTAL);
	RTHOOK(1);
