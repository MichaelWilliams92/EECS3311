...
extern EIF_TYPED_VALUE F684_2681(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F684_2682(EIF_REFERENCE);
extern EIF_TYPED_VALUE F684_2683(EIF_REFERENCE);
extern void F684_5335(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F684_2681 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 683, Current, 2, 1, 4683);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(683, Current, 4683);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tu2_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1282, "item", arg1))(arg1)).it_n2);
...
/* {LIST}.after */
EIF_TYPED_VALUE F684_2682 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 683, Current, 0, 0, 4684);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {LIST}.before */
EIF_TYPED_VALUE F684_2683 (EIF_REFERENCE Current)
{
	GTCX
...
/* {LIST}._invariant */
void F684_5335 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 683, Current, 0, 5334);
	RTSA(dtype);
	RTME(dtype, 0);
