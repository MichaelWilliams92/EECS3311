...
extern EIF_TYPED_VALUE F256_1400(EIF_REFERENCE);
extern void F256_5311(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F256_1400 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 255, Current, 0, 0, 1849);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(255, Current, 1849);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F256_5311 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 255, Current, 0, 5310);
	RTSA(dtype);
	RTME(dtype, 0);
