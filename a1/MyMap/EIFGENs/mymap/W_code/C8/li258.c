...
extern EIF_TYPED_VALUE F258_2681(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F258_2682(EIF_REFERENCE);
extern EIF_TYPED_VALUE F258_2683(EIF_REFERENCE);
extern void F258_5335(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F258_2681 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 257, Current, 2, 1, 4647);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(257, Current, 4647);
	RTCC(arg1, 257, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
...
/* {LIST}.after */
EIF_TYPED_VALUE F258_2682 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 257, Current, 0, 0, 4648);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(257, Current, 4648);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F258_2683 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 257, Current, 0, 0, 4649);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(257, Current, 4649);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F258_5335 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 257, Current, 0, 5334);
	RTSA(dtype);
	RTME(dtype, 0);
