...
extern void F63_1230(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F63_1231(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F63_1232(EIF_REFERENCE);
extern EIF_TYPED_VALUE F63_1233(EIF_REFERENCE);
extern EIF_TYPED_VALUE F63_1234(EIF_REFERENCE);
...
void F63_1230 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 62, Current, 0, 2, 1384);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(62, Current, 1384);
	if (arg1) {
		RTCC(arg1, 62, l_feature_name, 1, eif_new_type(194, 0x00), 0x00);
	}
	if (arg2) {
		{
			static EIF_TYPE_INDEX typarr0[] = {228,0xFF01,0xFFF9,0,143,0xFFFF};
			EIF_TYPE typres0;
			static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
			
			typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(Dftype(Current), typarr0)));
			RTCC(arg2, 62, l_feature_name, 2, typres0, 0x00);
		}
	}
	RTIV(Current, RTAL);
body:;
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1158, 0xF80000E4, 0); /* case */
	RTAR(Current, arg2);
	...
	*(EIF_REFERENCE *)(Current + RTWA(1156, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 1160, 0xF80000C2, 0); /* expected_tag_name */
	tr1 = RTMS_EX_H("NONE",4,1313820229);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(1160, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(5);
...
void F63_1231 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 62, Current, 1, 3, 1385);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(62, Current, 1385);
	if (arg1) {
		RTCC(arg1, 62, l_feature_name, 1, eif_new_type(194, 0x00), 0x00);
	}
	if (arg2) {
	...
	if (arg3) {
		RTCC(arg3, 62, l_feature_name, 3, eif_new_type(194, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_REFERENCE *)(Current + RTWA(1156, dtype)) = (EIF_REFERENCE) tr1;
	...
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(1160, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(8);
	RTDBGAA(Current, dtype, 1155, 0xF80000C2, 0); /* bookmark_name */
	tr1 = RTMS_EX_H("",0,0);
	RTAR(Current, tr1);
...
void F63_1232 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 62, Current, 3, 0, 1386);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(62, Current, 1386);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
		...
		RTHOOK(3);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(3293, "apply", loc2))(loc2);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 1152, 0x04000000, 1); /* passed */
		*(EIF_BOOLEAN *)(Current + RTWA(1152, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	}
	RTVI(Current, RTAL);
	RTRS;
	RTE_E
	...
	RTHOOK(5);
	tb1 = '\01';
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1129, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	ur1 = RTCCL(tr1);
...
EIF_TYPED_VALUE F63_1233 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 62, Current, 0, 0, 1387);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(62, Current, 1387);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F63_1234 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(1160,Dtype(Current)));
	return r;
}
