...
extern EIF_TYPED_VALUE F59_1188(EIF_REFERENCE);
...
RTOID (F59_1188)
EIF_TYPED_VALUE F59_1188 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 58, Current, 0, 0, 1345);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(58, Current, 1345);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
