...
extern void F49_1003(EIF_REFERENCE);
extern void F49_1004(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F49_1005(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern void F49_1009(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F49_1010(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F49_1011(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F49_1012(EIF_REFERENCE);
extern EIF_TYPED_VALUE F49_1013(EIF_REFERENCE);
extern EIF_TYPED_VALUE F49_1014(EIF_REFERENCE);
extern EIF_TYPED_VALUE F49_1015(EIF_REFERENCE);
extern EIF_TYPED_VALUE F49_1016(EIF_REFERENCE);
extern EIF_TYPED_VALUE F49_1017(EIF_REFERENCE);
extern EIF_TYPED_VALUE F49_1018(EIF_REFERENCE);
extern EIF_TYPED_VALUE F49_1019(EIF_REFERENCE);
extern EIF_TYPED_VALUE F49_1020(EIF_REFERENCE);
extern EIF_TYPED_VALUE F49_1021(EIF_REFERENCE);
extern EIF_TYPED_VALUE F49_1022(EIF_REFERENCE);
extern EIF_TYPED_VALUE F49_1023(EIF_REFERENCE);
extern EIF_TYPED_VALUE F49_1024(EIF_REFERENCE);
extern EIF_TYPED_VALUE F49_1025(EIF_REFERENCE);
extern EIF_TYPED_VALUE F49_1026(EIF_REFERENCE);
extern EIF_TYPED_VALUE F49_1027(EIF_REFERENCE);
...
void F49_1003 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 48, Current, 0, 0, 1171);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1171);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F49_1004 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 48, Current, 0, 1, 1172);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1172);
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(946, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	RTHOOK(3);
	RTDBGAA(Current, dtype, 980, 0x3C000000, 1); /* part1 */
	*(EIF_NATURAL_64 *)(Current + RTWA(980, dtype)) = (EIF_NATURAL_64) (EIF_NATURAL_64) ((EIF_INTEGER_32) 0L);
	RTHOOK(4);
	RTDBGAA(Current, dtype, 981, 0x3C000000, 1); /* part2 */
	*(EIF_NATURAL_64 *)(Current + RTWA(981, dtype)) = (EIF_NATURAL_64) (EIF_NATURAL_64) ((EIF_INTEGER_32) 0L);
	RTHOOK(5);
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(938, dtype)) = (EIF_INTEGER_32) arg1;
	RTHOOK(7);
	RTDBGAA(Current, dtype, 982, 0x04000000, 1); /* internal_overflowed */
	*(EIF_BOOLEAN *)(Current + RTWA(982, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	if (RTAL & CK_ENSURE) {
		RTHOOK(8);
		...
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(982, dtype));
		...
		tu8_1 = *(EIF_NATURAL_64 *)(Current + RTWA(980, dtype));
		...
		tu8_1 = *(EIF_NATURAL_64 *)(Current + RTWA(981, dtype));
		if ((EIF_BOOLEAN)(tu8_1 == (EIF_NATURAL_64) ((EIF_INTEGER_32) 0L))) {
			RTCK;
		} else {
			RTCF;
...
EIF_TYPED_VALUE F49_1005 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 48, Current, 4, 1, 1173);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(48, Current, 1173);
	RTCC(arg1, 48, l_feature_name, 1, eif_new_type(194, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F49_1006 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 48, Current, 0, 0, 1174);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1174);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = *(EIF_BOOLEAN *)(Current + RTWA(982, dtype));
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(947, dtype));
...
EIF_TYPED_VALUE F49_1007 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 48, Current, 0, 0, 1175);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1175);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = *(EIF_BOOLEAN *)(Current + RTWA(982, dtype));
...
EIF_TYPED_VALUE F49_1008 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 48, Current, 0, 0, 1176);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1176);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(946, dtype));
...
void F49_1009 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 48, Current, 8, 2, 1177);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1177);
	RTCC(arg1, 48, l_feature_name, 1, eif_new_type(186, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F49_1010 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 48, Current, 3, 1, 1178);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1178);
	RTIV(Current, RTAL);
	RTHOOK(1);
		...
		switch (loc3) {
			case 0L:
				...
				if (tb1) {
					...
					*(EIF_NATURAL_64 *)(Current + RTWA(981, dtype)) = (EIF_NATURAL_64) tu8_1;
				} else {
					RTHOOK(8);
				...
				if (tb1) {
					...
					*(EIF_NATURAL_64 *)(Current + RTWA(981, dtype)) = (EIF_NATURAL_64) tu8_1;
					...
					if ((EIF_BOOLEAN)(ti4_1 != ti4_2)) {
						...
						tu8_1 = *(EIF_NATURAL_64 *)(Current + RTWA(980, dtype));
						uu8_1 = tu8_1;
						tu8_2 = *(EIF_NATURAL_64 *)(Current + RTWA(981, dtype));
						uu8_2 = tu8_2;
						ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(938, dtype));
						ui4_1 = ti4_1;
						...
						if (tb1) {
							RTHOOK(21);
							RTDBGAA(Current, dtype, 982, 0x04000000, 1); /* internal_overflowed */
							*(EIF_BOOLEAN *)(Current + RTWA(982, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
							RTHOOK(22);
							RTDBGAA(Current, dtype, 980, 0x3C000000, 1); /* part1 */
							*(EIF_NATURAL_64 *)(Current + RTWA(980, dtype)) = (EIF_NATURAL_64) loc1;
							RTHOOK(23);
							RTDBGAA(Current, dtype, 981, 0x3C000000, 1); /* part2 */
							*(EIF_NATURAL_64 *)(Current + RTWA(981, dtype)) = (EIF_NATURAL_64) loc2;
							RTHOOK(24);
							RTDBGAL(Current, 3, 0x10000000, 1, 0); /* loc3 */
			...
			case 2L:
				...
				if (tb1) {
					...
					loc1 = *(EIF_NATURAL_64 *)(Current + RTWA(980, dtype));
					RTHOOK(28);
					RTDBGAL(Current, 2, 0x3C000000, 1, 0); /* loc2 */
					loc2 = *(EIF_NATURAL_64 *)(Current + RTWA(981, dtype));
					RTHOOK(29);
					RTDBGAA(Current, dtype, 980, 0x3C000000, 1); /* part1 */
					tu8_1 = *(EIF_NATURAL_64 *)(Current + RTWA(980, dtype));
					tu8_2 = *(EIF_NATURAL_64 *)(Current + RTWA(981, dtype));
					*(EIF_NATURAL_64 *)(Current + RTWA(980, dtype)) = (EIF_NATURAL_64) (EIF_NATURAL_64) ((EIF_NATURAL_64) (tu8_1 * (EIF_NATURAL_64) ((EIF_INTEGER_32) 10L)) + tu8_2);
					RTHOOK(30);
					RTDBGAA(Current, dtype, 981, 0x3C000000, 1); /* part2 */
					ti4_1 = (EIF_INTEGER_32) (arg1);
					tu8_1 = (EIF_NATURAL_64) (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 48L));
					*(EIF_NATURAL_64 *)(Current + RTWA(981, dtype)) = (EIF_NATURAL_64) tu8_1;
					...
					if ((EIF_BOOLEAN)(ti4_1 != ti4_2)) {
						...
						ui4_2 = ti4_2;
						tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(924, "will_overflow", tr1))(tr1, uu8_1x, uu8_2x, ui4_1x, ui4_2x)).it_b);
						*(EIF_BOOLEAN *)(Current + RTWA(982, dtype)) = (EIF_BOOLEAN) tb1;
						RTHOOK(33);
						tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(935, dtype))(Current)).it_b);
						if (tb1) {
							RTHOOK(34);
...
EIF_TYPED_VALUE F49_1011 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 48, Current, 0, 1, 1179);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(48, Current, 1179);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	ui4_1 = arg1;
...
EIF_TYPED_VALUE F49_1012 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 48, Current, 0, 0, 1180);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1180);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(946, dtype));
...
EIF_TYPED_VALUE F49_1013 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 48, Current, 0, 0, 1181);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1181);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(946, dtype));
...
EIF_TYPED_VALUE F49_1014 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 48, Current, 0, 0, 1182);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1182);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(947, dtype));
...
EIF_TYPED_VALUE F49_1015 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 48, Current, 0, 0, 1183);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1183);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(947, dtype));
	if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 1L))) {
...
EIF_TYPED_VALUE F49_1016 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 48, Current, 0, 0, 1184);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1184);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(947, dtype));
	if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 1L))) {
...
EIF_TYPED_VALUE F49_1017 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 48, Current, 0, 0, 1185);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1185);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(947, dtype));
	if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 1L))) {
...
EIF_TYPED_VALUE F49_1018 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 48, Current, 0, 0, 1186);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1186);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(947, dtype));
	if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 1L))) {
...
EIF_TYPED_VALUE F49_1019 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 48, Current, 0, 0, 1187);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1187);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F49_1020 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 48, Current, 0, 0, 1188);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1188);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F49_1021 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 48, Current, 0, 0, 1189);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1189);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F49_1022 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 48, Current, 0, 0, 1190);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1190);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x38000000, 1,0); /* Result */
	tu8_1 = *(EIF_NATURAL_64 *)(Current + RTWA(980, dtype));
...
EIF_TYPED_VALUE F49_1023 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 48, Current, 0, 0, 1166);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1166);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x3C000000, 1,0); /* Result */
	Result = *(EIF_NATURAL_64 *)(Current + RTWA(980, dtype));
	tu8_1 = *(EIF_NATURAL_64 *)(Current + RTWA(981, dtype));
...
RTOID (F49_1024)
EIF_TYPED_VALUE F49_1024 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 48, Current, 0, 0, 1167);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(48, Current, 1167);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
EIF_TYPED_VALUE F49_1025 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_UINT64;
	r.it_n8 = *(EIF_NATURAL_64 *)(Current + RTWA(980,Dtype(Current)));
	return r;
}


/* {STRING_TO_INTEGER_CONVERTOR}.part2 */
EIF_TYPED_VALUE F49_1026 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_UINT64;
	r.it_n8 = *(EIF_NATURAL_64 *)(Current + RTWA(981,Dtype(Current)));
	return r;
}


/* {STRING_TO_INTEGER_CONVERTOR}.internal_overflowed */
EIF_TYPED_VALUE F49_1027 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(982,Dtype(Current)));
	return r;
}
