...
extern EIF_TYPED_VALUE F285_1387(EIF_REFERENCE);
extern void F285_1390(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F285_5308(EIF_REFERENCE, int);
...
/* {BILINEAR}.off */
EIF_TYPED_VALUE F285_1387 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 284, Current, 0, 0, 1790);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(284, Current, 1790);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BILINEAR}.search */
void F285_1390 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 284, Current, 0, 1, 1791);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(284, Current, 1791);
	RTCC(arg1, 284, l_feature_name, 1, RTWCT(1236, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1252, dtype))(Current)).it_b);
...
/* {BILINEAR}._invariant */
void F285_5308 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 284, Current, 0, 5307);
	RTSA(dtype);
	RTME(dtype, 0);
