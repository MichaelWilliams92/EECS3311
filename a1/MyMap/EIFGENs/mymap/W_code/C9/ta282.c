...
extern void F282_1425(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F282_1425 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 281, Current, 0, 1, 1982);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(281, Current, 1982);
	RTCC(arg1, 281, l_feature_name, 1, RTWCT(1235, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
