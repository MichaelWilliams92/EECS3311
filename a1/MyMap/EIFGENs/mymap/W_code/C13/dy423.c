...
extern void F423_2685(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F423_2687(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F423_2688(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F423_2692(EIF_REFERENCE);
...
void F423_2685 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 422, Current, 1, 1, 4710);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(422, Current, 4710);
	RTIV(Current, RTAL);
...
void F423_2687 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 422, Current, 0, 1, 4711);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(422, Current, 4711);
...
body:;
	...
	for (;;) {
		...
		uc1 = tc1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2210, dtype))(Current, uc1x);
		RTHOOK(8);
...
void F423_2688 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 422, Current, 0, 1, 4712);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(422, Current, 4712);
	RTCC(arg1, 422, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F423_2692 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 422, Current, 0, 0, 4713);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(422, Current, 4713);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
