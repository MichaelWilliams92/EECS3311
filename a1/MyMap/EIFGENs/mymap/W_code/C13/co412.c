...
extern EIF_TYPED_VALUE F412_1411(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F412_1414(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F412_1416(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F412_1411 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 411, Current, 0, 1, 1957);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(411, Current, 1957);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	uc1 = arg1;
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1227, Dtype(Current)))(Current, uc1x)).it_b);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
/* {COLLECTION}.fill */
void F412_1414 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 411, Current, 1, 1, 1958);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(411, Current, 1958);
	{
...
void F412_1416 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 411, Current, 0, 1, 1959);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(411, Current, 1959);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	for (;;) {
		...
		RTHOOK(3);
		uc1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1272, dtype))(Current, uc1x);
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
