...
extern EIF_TYPED_VALUE F140_3037(EIF_REFERENCE);
...
EIF_TYPED_VALUE F140_3037 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 139, Current, 0, 0, 6342);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(139, Current, 6342);
	RTIV(Current, RTAL);
	RTHOOK(1);
