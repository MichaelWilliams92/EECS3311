...
extern void F135_2749(EIF_REFERENCE);
extern EIF_TYPED_VALUE F135_2750(EIF_REFERENCE);
...
void F135_2749 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 134, Current, 2, 0, 4889);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(134, Current, 4889);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F135_2750)
EIF_TYPED_VALUE F135_2750 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 134, Current, 0, 0, 4890);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(134, Current, 4890);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
