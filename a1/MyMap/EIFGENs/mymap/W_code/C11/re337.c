...
extern EIF_TYPED_VALUE F337_2532(EIF_REFERENCE);
...
EIF_TYPED_VALUE F337_2532 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 336, Current, 0, 0, 3516);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(336, Current, 3516);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000152, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,338,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
