...
extern void F335_1425(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F335_1425 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 334, Current, 0, 1, 1984);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(334, Current, 1984);
	RTCC(arg1, 334, l_feature_name, 1, RTWCT(1235, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
