...
feature -- type queries 
	...
	is_year(v: INTEGER_64): BOOLEAN 
		require
			comment("v: YEAR = 1900 .. 3000")
		do
			 Result := 
				(1900 <= v) and then (v <= 3000)
		ensure
			 Result = 
				(1900 <= v) and then (v <= 3000)
		end

	is_date(v: TUPLE[d: INTEGER_64; m: INTEGER_64; y: INTEGER_64]): BOOLEAN 
		require
			comment("v: DATE = TUPLE[d: DAY = 1 .. 31; m: MONTH = 1 .. 12; y: YEAR = 1900 .. 3000]")
		do
			 Result := 
				         is_day(v.d)
