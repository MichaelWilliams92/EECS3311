...
extern void F883_7222(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F883_7223(EIF_REFERENCE);
extern EIF_TYPED_VALUE F883_7224(EIF_REFERENCE);
extern EIF_TYPED_VALUE F883_7225(EIF_REFERENCE);
...
void F883_7222 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 882, Current, 0, 2, 12869);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(882, Current, 12869);
	RTCC(arg1, 882, l_feature_name, 1, eif_new_type(220, 0x01), 0x01);
	{
		...
		RTCC(arg2, 882, l_feature_name, 2, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5119, 0xF8000133, 0); /* case */
	RTAR(Current, arg2);
...
void F883_7223 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 882, Current, 3, 0, 12866);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(882, Current, 12866);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
		...
		ur1 = tr1;
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4336, "item", loc2))(loc2, ur1x)).it_b);
		if (tb1) {
			RTHOOK(4);
...
EIF_TYPED_VALUE F883_7224 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 882, Current, 0, 0, 12867);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(882, Current, 12867);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F883_7225 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
