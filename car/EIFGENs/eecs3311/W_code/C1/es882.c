...
extern void F882_7217(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F882_7218(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F882_7219(EIF_REFERENCE);
extern EIF_TYPED_VALUE F882_7220(EIF_REFERENCE);
extern EIF_TYPED_VALUE F882_7221(EIF_REFERENCE);
...
void F882_7217 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 881, Current, 0, 2, 12861);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,249,0xFF01,0xFFF9,0,174,0xFFFF};
		EIF_TYPE typres0;
...
body:;
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5119, 0xF80000F9, 0); /* case */
	RTAR(Current, arg2);
	*(EIF_REFERENCE *)(Current + RTWA(5119, dtype)) = (EIF_REFERENCE) RTCCL(arg2);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 5115, 0xF80000DC, 0); /* case_name */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(5115, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(3);
	RTDBGAA(Current, dtype, 5117, 0xF80000DC, 0); /* violation_tag */
	tr1 = RTMS_EX_H("",0,0);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(5117, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 5121, 0xF80000DC, 0); /* expected_tag_name */
...
void F882_7218 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 881, Current, 1, 3, 12862);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(881, Current, 12862);
	RTCC(arg1, 881, l_feature_name, 1, eif_new_type(220, 0x01), 0x01);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,249,0xFF01,0xFFF9,0,174,0xFFFF};
		EIF_TYPE typres0;
	...
	RTCC(arg3, 881, l_feature_name, 3, eif_new_type(220, 0x01), 0x01);
	RTIV(Current, RTAL);
...
void F882_7219 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 881, Current, 3, 0, 12863);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if ((EIF_BOOLEAN) !loc1) {
		...
		RTHOOK(3);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(4311, "apply", loc2))(loc2);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 5113, 0x04000000, 1); /* passed */
		*(EIF_BOOLEAN *)(Current + RTWA(5113, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	}
	RTVI(Current, RTAL);
	RTRS;
	RTE_E
	...
	if (tb1) {
		RTHOOK(6);
		RTDBGAA(Current, dtype, 5113, 0x04000000, 1); /* passed */
		*(EIF_BOOLEAN *)(Current + RTWA(5113, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	} else {
		RTHOOK(7);
		RTDBGAA(Current, dtype, 5114, 0x04000000, 1); /* contract_violated */
		*(EIF_BOOLEAN *)(Current + RTWA(5114, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
		RTHOOK(8);
		RTCT0(NULL, EX_CHECK);
		...
		*(EIF_REFERENCE *)(Current + RTWA(5117, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(10);
		RTDBGAA(Current, dtype, 5118, 0x10000000, 1); /* violation_type */
...
EIF_TYPED_VALUE F882_7220 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 881, Current, 0, 0, 12864);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F882_7221 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
