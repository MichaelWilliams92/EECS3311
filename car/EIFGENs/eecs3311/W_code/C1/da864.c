...
extern EIF_TYPED_VALUE F864_7003(EIF_REFERENCE);
...
EIF_TYPED_VALUE F864_7003 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F864_7003,12682,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 863, Current, 0, 0, 12676);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 863, Current, 0, 0, 12677);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
{
	GTCX
	RTOTC (F864_7008,12679,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F864_7009,12680,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F864_7010,12681,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit864 (void)
{
	GTCX
	RTOTS (7003,F864_7003)
	RTOTS (7004,F864_7004)
	RTOTS (7005,F864_7005)
	RTOTS (7006,F864_7006)
	RTOTS (7007,F864_7007)
	RTOTS (7008,F864_7008)
	RTOTS (7009,F864_7009)
	RTOTS (7010,F864_7010)
}
