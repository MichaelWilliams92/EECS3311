...
extern EIF_TYPED_VALUE F875_7136(EIF_REFERENCE);
extern EIF_TYPED_VALUE F875_7137(EIF_REFERENCE);
extern EIF_TYPED_VALUE F875_7138(EIF_REFERENCE);
...
EIF_TYPED_VALUE F875_7136 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F875_7137 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F875_7138 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 874, Current, 0, 0, 12795);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(874, Current, 12795);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(5012, "fractional_second", tr1));
